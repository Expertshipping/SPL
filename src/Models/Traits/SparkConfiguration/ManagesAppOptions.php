...
namespace ExpertShipping\Spl\Models\Traits\SparkConfiguration;
...
trait ManagesAppOptions
{
     ...
     * @var string
     */
    public static string $afterLoginRedirectTo = '/dashboard-dispatcher';
     ...
     * @var bool
     */
    public static bool $showTeamSwitcher = true;
     ...
     * @var bool
     */
    public static bool $createsAdditionalTeams = true;
     ...
     * @var string
     */
    public static string $teamsPrefix = 'teams';
     ...
     * @var string|int
     */
    public static string|int $minimumPasswordLength = 6;
     ...
     * @var bool
     */
    public static bool $mustVerifyEmail = false;
     ...
     * @var bool
     */
    public static bool $usesRightToLeftTheme = false;
     ...
     * @return void
     */
    public static function afterLoginRedirectTo(string $path): void
    {
