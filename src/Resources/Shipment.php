...
class Shipment extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'estimated_delivery_days' => $this->estimated_delivery_date ? (int) $this->estimated_delivery_date->diffInDays($this->created_at, true) : null,
            'pickup_days' => $this->picked_up_at ? (int) $this->picked_up_at->diffInDays($this->created_at, true) : null,
            'delivery_days' => $this->delivered_at ? (int) $this->delivered_at->diffInDays($this->created_at, true) : null,
