...
class PurolatorEvent extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'signature' => $this->getFirstMediaUrl('carrier-event-signatures'),
            'events' => new PurolatorEventCollection($this->whenLoaded('events')),
