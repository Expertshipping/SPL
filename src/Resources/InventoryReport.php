...
class InventoryReport extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'products'                  => $this->getProductsFromInvenotry($this->products, Product::with('category.media')->get()),
            'alert'                     => $this->alert,
            'parent'                    => $this->parent,
    ...
    private function getProductsFromInvenotry($products, $productsModels){
